...
/// for associating data with their list items.  Values must be unique
/// within the width of a pointer in order for comparisons to be safe in
...
impl Data for () {
    ...
    unsafe fn newt_from_ptr(_ptr: *const c_void) -> Self { }
}
