...
fn checkbox_get_multi_selection_char() {
    ...
    checkbox_tree.add_item("entry1", 'a', 0, &[0]);
    checkbox_tree.add_item("entry2", 'b', 0, &[0]);
    checkbox_tree.add_item("entry3", 'c', 0, &[0]);
...
fn checkbox_get_multi_selection_i8() {
    let mut checkbox_tree: CheckboxTree<i8> =
        CheckboxTree::new(0, 0, 10, Some(&[' ', 'X', 'Y']), 0);
    checkbox_tree.add_item("entry1", i8::MIN, 0, &[0]);
    checkbox_tree.add_item("entry2", 0, 0, &[0]);
    checkbox_tree.add_item("entry3", i8::MAX, 0, &[0]);
...
fn checkbox_get_multi_selection_i32() {
    let mut checkbox_tree: CheckboxTree<i32> =
        CheckboxTree::new(0, 0, 10, Some(&[' ', 'X', 'Y']), 0);
    checkbox_tree.add_item("entry1", i32::MIN, 0, &[0]);
    checkbox_tree.add_item("entry2", 0, 0, &[0]);
    checkbox_tree.add_item("entry3", i32::MAX, 0, &[0]);
...
fn checkbox_get_multi_selection_isize() {
    let mut checkbox_tree: CheckboxTree<isize> =
        CheckboxTree::new(0, 0, 10, Some(&[' ', 'X', 'Y']), 0);
    checkbox_tree.add_item("entry1", isize::MIN, 0, &[0]);
    checkbox_tree.add_item("entry2", 0, 0, &[0]);
    checkbox_tree.add_item("entry3", isize::MAX, 0, &[0]);
...
fn checkbox_get_multi_selection_u8() {
    let mut checkbox_tree: CheckboxTree<u8> =
        CheckboxTree::new(0, 0, 10, Some(&[' ', 'X', 'Y']), 0);
    let mid = u8::MAX / 2;
    checkbox_tree.add_item("entry1", u8::MIN, 0, &[0]);
    checkbox_tree.add_item("entry2", mid, 0, &[0]);
    checkbox_tree.add_item("entry3", u8::MAX, 0, &[0]);
...
fn checkbox_get_multi_selection_u32() {
    let mut checkbox_tree: CheckboxTree<u32> =
        CheckboxTree::new(0, 0, 10, Some(&[' ', 'X', 'Y']), 0);
    let mid = u32::MAX / 2;
    checkbox_tree.add_item("entry1", u32::MIN, 0, &[0]);
    checkbox_tree.add_item("entry2", mid, 0, &[0]);
    checkbox_tree.add_item("entry3", u32::MAX, 0, &[0]);
...
fn checkbox_get_multi_selection_usize() {
    let mut checkbox_tree: CheckboxTree<usize> =
        CheckboxTree::new(0, 0, 10, Some(&[' ', 'X', 'Y']), 0);
    let mid = usize::MAX / 2;
    checkbox_tree.add_item("entry1", usize::MIN, 0, &[0]);
    checkbox_tree.add_item("entry2", mid, 0, &[0]);
    checkbox_tree.add_item("entry3", usize::MAX, 0, &[0]);
...
fn checkbox_tree_get_multi_selection_struct() {
    ...
    checkbox_tree.add_item("entry1", Data(&st1), 0, &[0]);
    checkbox_tree.add_item("entry2", Data(&st2), 0, &[0]);
    checkbox_tree.add_item("entry3", Data(&st3), 0, &[0]);
    ...
    let result = checkbox_tree.get_multi_selection('X');
    assert!(result.len() == 2);
    assert!(result[0].v1 == 12);
    assert!(result[0].v2 == 27);
    assert!(result[0].v3 == "Baz");
    assert!(result[1].v1 == 10);
    assert!(result[1].v2 == 25);
    assert!(result[1].v3 == "Foo");
}
