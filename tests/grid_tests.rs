...
fn vertical_grid_create() {
    ...
    let grid = VerticalStackedGrid::new(buttons);
    assert!(grid.grid() != ptr::null_mut());
    ...
    let mut b2 = Button::new(0, 0, "No");
    let buttons: &mut [&mut dyn Component] = &mut [&mut b1, &mut b2];
    let grid = VerticalStackedGrid::new_close_stacked(buttons);
    assert!(grid.grid() != ptr::null_mut());
...
fn horizontal_grid_create() {
    ...
    let mut b2 = Button::new(0, 0, "No");
    let buttons: &mut [&mut dyn Component] = &mut [&mut b1, &mut b2];
    let grid = HorizontalStackedGrid::new(buttons);
    assert!(grid.grid() != ptr::null_mut());
    ...
    let mut b2 = Button::new(0, 0, "No");
    let buttons: &mut [&mut dyn Component] = &mut [&mut b1, &mut b2];
    let grid = HorizontalStackedGrid::new_close_stacked(buttons);
    assert!(grid.grid() != ptr::null_mut());
